...
ASTAR EULA는 저작물을 자유롭게 공유하거나 수정하는 행위를 제약하기 위해 고안되었다. 
...
- 제 1조, 배포 및 재배포의 금지, 이 프로그램은 무조건적으로 저작권자를 제외한 배포 및 재배포가 불가능하다.
- 제 2조, 사용공개의 강제성, 이 프로그램을 사용 중인 서버는 프로그램의 사용유무를 반드시 유저가 알 수 있게 해야한다.
- 제 3조, 코드수정의 금지,  이 프로그램을 사용 중인 서버는 프로그램의 코드를 수정해서 사용할 수 없다.
- 제 4조, 소프트웨어 사용권 동의서 첨부의무, 이 프로그램을 배포 시엔 LICENSE.md 파일을 반드시 첨부해야한다.
- 제 5조, 소프트웨어의 법적 보호성, 이 프로그램의 소스 코드는 저작권 및 특허권에 의해 보호받는다.
- 제 6조, 소프트웨어 판매 금지, 저작권자를 제외한 프로그램 및 소스 코드 판매 등의 상업적 사용을 금지한다.
- 제 7조, 소프트웨어의 무단사용 금지, 저작권자에게 라이센스를 직접 구매하지 않은 사용자는 프로그램의 모든 사용을 금지한다.
